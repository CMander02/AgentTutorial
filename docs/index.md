...
5. [实战一：本地知识库管理](practice-obsidian/index.md)：用 Claude Code + Obsidian 管理个人知识库。
6. [实战二：自动知识摄取](practice-ingestion/index.md)：用 Hermes + 知识摄入 Skill 自动抓取互联网内容和手动内容。
